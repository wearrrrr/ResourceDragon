...
void ThemeManager::Dark() {
    ...
    colors[ImGuiCol_FrameBgActive]          = ImVec4(0.13f, 0.14f, 0.14f, 1.00f);
    ...
    colors[ImGuiCol_CheckMark]              = ImVec4(0.49f, 0.46f, 0.66f, 1.00f);
    colors[ImGuiCol_SliderGrab]             = ImVec4(0.39f, 0.36f, 0.56f, 1.00f);
    colors[ImGuiCol_SliderGrabActive]       = ImVec4(0.43f, 0.40f, 0.60f, 1.00f);
    colors[ImGuiCol_Button]                 = ImVec4(0.28f, 0.31f, 0.52f, 1.00f);
    colors[ImGuiCol_ButtonHovered]          = ImVec4(0.23f, 0.25f, 0.40f, 1.00f);
    colors[ImGuiCol_ButtonActive]           = ImVec4(0.32f, 0.34f, 0.52f, 1.00f);
    colors[ImGuiCol_Header]                 = ImVec4(0.24f, 0.26f, 0.44f, 1.00f);
    colors[ImGuiCol_HeaderHovered]          = ImVec4(0.28f, 0.31f, 0.48f, 1.00f);
    colors[ImGuiCol_HeaderActive]           = ImVec4(0.32f, 0.34f, 0.52f, 1.00f);
    colors[ImGuiCol_Separator]              = ImVec4(0.44f, 0.44f, 0.44f, 1.00f);
    colors[ImGuiCol_SeparatorHovered]       = ImVec4(0.49f, 0.46f, 0.66f, 1.00f);
    colors[ImGuiCol_SeparatorActive]        = ImVec4(0.46f, 0.47f, 0.66f, 1.00f);
    colors[ImGuiCol_ResizeGrip]             = ImVec4(0.36f, 0.39f, 0.56f, 1.00f);
    colors[ImGuiCol_ResizeGripHovered]      = ImVec4(0.40f, 0.41f, 0.60f, 1.00f);
    colors[ImGuiCol_ResizeGripActive]       = ImVec4(0.44f, 0.46f, 0.64f, 1.00f);
    colors[ImGuiCol_InputTextCursor]        = ImVec4(1.00f, 1.00f, 1.00f, 1.00f);
    colors[ImGuiCol_TabHovered]             = ImVec4(0.30f, 0.28f, 0.48f, 1.00f);
    colors[ImGuiCol_Tab]                    = ImVec4(0.17f, 0.19f, 0.20f, 1.00f);
    colors[ImGuiCol_TabSelected]            = ImVec4(0.32f, 0.34f, 0.52f, 1.00f);
    colors[ImGuiCol_TabSelectedOverline]    = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
    colors[ImGuiCol_TabDimmed]              = ImVec4(0.15f, 0.16f, 0.17f, 1.00f);
    ...
    colors[ImGuiCol_DockingPreview]         = ImVec4(0.46f, 0.46f, 0.66f, 0.70f);
    ...
    colors[ImGuiCol_TableHeaderBg]          = ImVec4(0.11f, 0.12f, 0.12f, 1.00f);
    colors[ImGuiCol_TableBorderStrong]      = ImVec4(0.12f, 0.13f, 0.13f, 0.00f);
    colors[ImGuiCol_TableBorderLight]       = ImVec4(0.10f, 0.11f, 0.11f, 1.00f);
    colors[ImGuiCol_TableRowBg]             = ImVec4(0.06f, 0.06f, 0.07f, 1.00f);
    colors[ImGuiCol_TableRowBgAlt]          = ImVec4(0.07f, 0.07f, 0.08f, 1.00f);
    colors[ImGuiCol_TextLink]               = ImVec4(0.42f, 0.69f, 1.00f, 1.00f);
    colors[ImGuiCol_TextSelectedBg]         = ImVec4(0.24f, 0.34f, 0.44f, 0.35f);
    colors[ImGuiCol_TreeLines]              = ImVec4(0.43f, 0.43f, 0.50f, 0.50f);
    colors[ImGuiCol_DragDropTarget]         = ImVec4(0.47f, 0.46f, 0.66f, 0.90f);
    colors[ImGuiCol_NavCursor]              = ImVec4(0.48f, 0.46f, 0.66f, 1.00f);
